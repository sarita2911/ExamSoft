...
public class UserData extends JPanel{
	...
	public void makeGUI()
	{
		...
		label_2.setBounds(700, 120, 242, 26);
		add(label_2);
		
		JLabel lblRegDate = new JLabel("REG Date : ");
		lblRegDate.setForeground(new Color(240, 255, 255));
		lblRegDate.setFont(new Font("Simplified Arabic Fixed", Font.BOLD, 18));
		lblRegDate.setBounds(600, 120, 109, 26);
		add(lblRegDate);
		
		JLabel label_1 = new JLabel(RegNo);
		label_1.setForeground(new Color(255, 255, 255));
		label_1.setFont(new Font("Simplified Arabic Fixed", Font.BOLD, 18));
		...
		JADDRESS.setBounds(476, 500, 331, 64);
		add(JADDRESS);
		...
		lblCollege.setBounds(381, 450, 85, 26);
		add(lblCollege);
		...
		lblDob.setBounds(381, 350, 85, 26);
		add(lblDob);
		...
		female.setBounds(530, 290, 90, 23);
		add(female);
		...
		JLAST.setColumns(10);
		JLAST.setBounds(817, 240, 116, 20);
		add(JLAST);
		...
		JMIDDLE.setBounds(650, 240, 116, 20);
		add(JMIDDLE);
		...
		lblPassword.setBounds(722, 180, 85, 26);
		add(lblPassword);
		...
		back.setBounds(80, 611, 140, 60);
		add(back);
		
		JLabel lblOnlineExamination = new JLabel("USER DETAILS");
		lblOnlineExamination.setBounds(428, 50, 535, 57);
		...
		btnNewButton.setBounds(1070, 86, 135, 43);
		add(btnNewButton);
