...
public class ShowResult extends JPanel {
	...
	public ShowResult(String[] r,String username) {
		...
		panel.setBounds(408, 120, 575, 401);
		add(panel);
		...
		save.setForeground(new Color(255, 255, 255));
                save.setBackground(new Color(2, 10, 48));
		save.setFont(new Font("Times New Roman", Font.BOLD, 18));
                save.setBounds(1120, 550, 155, 45);
		add(save);
		...
		Discard.setForeground(new Color(255, 255, 255));
                Discard.setBackground(new Color(2, 10, 48));
		Discard.setFont(new Font("Times New Roman", Font.BOLD, 18));
		Discard.setBounds(70, 550, 155, 45);
		add(Discard);
		...
		lblOnlineExamination.setBounds(561, 40, 270, 72);
