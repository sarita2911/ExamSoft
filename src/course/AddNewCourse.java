...
public class AddNewCourse extends JPanel implements FocusListener {
	...
	public AddNewCourse() {
		...
		lblEachMark.setBounds(491, 403, 181, 33);
		add(lblEachMark);
		...
		eachMark.setBounds(682, 399, 60, 36);
		add(eachMark);
		...
		courseName.setBounds(491, 262, 408, 36);
		add(courseName);
		courseName.setColumns(10);
		courseName.addFocusListener(this);
		
		btnShowCourse.setForeground(new Color(0, 0, 0));
                btnShowCourse.setBackground(new Color(255, 255, 255));
		btnShowCourse.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
		btnShowCourse.setBounds(572, 517, 256, 36);
		add(btnShowCourse);
		...
		btnNewButton.setBounds(50, 630, 100, 50);
		add(btnNewButton);
