...
public class EditCourse extends JPanel implements ItemListener{
	...
	public EditCourse(String courseName) {
		...
		updateEachMark.setFont(new Font("SimSun", Font.BOLD, 22));
		updateEachMark.setBounds(1190, 480, 57, 21);
		...
		JLabel lblTotalQuestions = new JLabel("Total Questions : "+TotalQuestions);
                lblTotalQuestions.setFont(new Font("SimSun", Font.BOLD, 22));
                lblTotalQuestions.setForeground(new Color(255, 255, 255));
		lblTotalQuestions.setBounds(1081, 540, 300, 24);
		...
		back.setBounds(1182, 50, 98, 54);
		add(back);

		JLabel label_1 = new JLabel(":");
                label_1.setFont(new Font("SimSun", Font.BOLD, 22));
                label_1.setForeground(new Color(255, 255, 255));
		label_1.setBounds(1184, 400, 9, 24);
		add(label_1);
		
		JLabel label = new JLabel(":");
                label.setFont(new Font("SimSun", Font.BOLD, 22));
                label.setForeground(new Color(255, 255, 255));
		label.setBounds(1128, 400, 9, 24);
		add(label);
		
		updateSS = new JTextField();
		updateSS.setColumns(10);
		updateSS.setBounds(1195, 400, 45, 20);
		add(updateSS);
		
		updateMM = new JTextField();
		updateMM.setColumns(10);
		updateMM.setBounds(1138, 400, 45, 20);
		add(updateMM);
		
		updateHH = new JTextField();
		updateHH.setColumns(10);
		updateHH.setBounds(1081, 400, 45, 20);
		add(updateHH);
		...
		updateCourseName.setBounds(1081, 300, 185, 20);
		...
		JLabel lblEachMark = new JLabel("Each Mark");
                lblEachMark.setFont(new Font("SimSun", Font.BOLD, 19));
                lblEachMark.setForeground(new Color(255, 255, 255));
		lblEachMark.setBounds(1081, 480, 150, 24);
		add(lblEachMark);
		
		JLabel lblTime = new JLabel("Time");
                lblTime.setFont(new Font("SimSun", Font.BOLD, 22));
                lblTime.setForeground(new Color(255, 255, 255));
		lblTime.setBounds(1081, 360, 100, 24);
		add(lblTime);
		
		JLabel lblCourseName = new JLabel("Course Name");
                lblCourseName.setFont(new Font("SimSun", Font.BOLD, 22));
                lblCourseName.setForeground(new Color(255, 255, 255));
		lblCourseName.setBounds(1081, 250, 200, 24);
		add(lblCourseName);
		save.setFont(new Font("Courier New", Font.PLAIN, 18));
		save.setBounds(1182, 595, 98, 54);
		add(save);
				
		jt=new JTabbedPane();
		jt.setBounds(100, 200, 741, 459);
		jt.addTab("New",New());
		jt.addTab("View",View());
		...
		JLabel lblOnlineExamination = new JLabel("Course : "+CourseName);
                lblOnlineExamination.setFont(new Font("SimSun", Font.BOLD, 22));
		lblOnlineExamination.setBounds(100, 50, 501, 68);
		...
		chckbxHide.setFont(new Font("Corbel", Font.BOLD, 18));
                chckbxHide.setForeground(new Color(255, 255, 255));
		chckbxHide.setBounds(1000, 50, 76, 24);
		add(chckbxHide);
